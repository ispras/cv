...
Если вся необходимая конфигурация (на подобие указанного выше дерева директорий) для проверяемой системы помещена в отдельную директорию с абсолютным путем plugin_dir,
то ее можно автоматически установить, выполнив команду:
./install_plugin.sh <plugin_dir> <system id>
Для установки плагина (конфигурации) поверх уже установленного необходимо выполнить команду:
./install_plugin.sh <plugin_dir> <system id> multiple
